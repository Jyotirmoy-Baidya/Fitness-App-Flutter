...
class TrackGoalScreen extends StatelessWidget {
  const TrackGoalScreen({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Center(
                child: Image.asset(
                  'assets/images/goal1.png', // Your image path here
            ...
            Padding(
              ...
              child: Column(
                ...
                children: const [
                  ...
                  SizedBox(height: 15),
                  Text(
                    "Finding your goals can be tough, but you’re not alone—we’ll help you every step of the way",
                    style: TextStyle(
                      fontSize: 14,
                ...
                child: GestureDetector(
                  onTap: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const GetBurnScreen(),
                      ),
                    );
                  },
                  child: Container(
